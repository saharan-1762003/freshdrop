        ...
        {editing && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-7 relative mb-40 mt-40"
            >
              ...
              <div className="relative w-full h-40  rounded-lg overflow-hidden mb-4 border border-gray-200 group">
                {imagePreview && (
                  <Image
                    src={imagePreview}
                    alt={editing.name}
