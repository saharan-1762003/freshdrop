  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
      ...
      transition={{
       ...
       <p className='text-gray-600 mb-8 flex items-center'>Join FreshDrop Today <Leaf className='w-5 h-5 text-green-600'/></p>
       <motion.form
      ...
      transition={{
       ...
       <div className='relative'>
        ...
        <input type="text" placeholder='Name' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none'
